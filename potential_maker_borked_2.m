...
function [VmatrixElement] = Vfunc(X,Y,Z)
    function [V0] = V0func(z,z0,wellDepth)
        V0 = wellDepth * exp(2*const.alpha*(z0-z))...
  ...
  function [Q] = Qhexfunc(X,Y)
        ...
        %+ V1func(Z) * Qfunc(X,Y)...
        zLevel = 0;
    VmatrixElement = V0func(Z,zLevel,const.MoS2Depth) ...
        + V1func(Z,zLevel+3.12,const.MoS2Depth) * Qhexfunc(X,Y);...
        %+ Qhexfunc(X-const.c/2,Y-(const.c*1/(2*sqrt(3)))) * V1func(Z,zLevel+1.56,7.63);
