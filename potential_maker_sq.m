...
noiseX = dsp.ColoredNoise(2,NumChannels=Nxy*Nsuper,SamplesPerFrame=Nxy*Nsuper);
noiseY = dsp.ColoredNoise(2,NumChannels=Nxy*Nsuper,SamplesPerFrame=Nxy*Nsuper);
