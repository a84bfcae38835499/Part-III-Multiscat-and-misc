...
p_S_D_NOO, c_S_D_NOO = curve_fit(
    i_S_D_NOO,Thetas,I00,
    p0 = 10,check_finite = True,nan_policy='raise',bounds=[0,np.inf]
    )
...
print("chi-squared = " + "{:.7f}".format(calculated_chi_squared(infodict_L,N,n_S_D_NOO)))
print("* - - - - - -")

p_S_R_2_NOO, c_S_R_2_NOO = curve_fit(
    i_S_R_2_NOO,Thetas,I00,
    p0 = [10.,0.,1.],check_finite = True,nan_policy='raise',bounds=[[0,0,0],[1000,2*np.pi,1.]]
    )
...
p_tb_medium, c_tb_medium = curve_fit(
    i_tb_M_D,Thetas,I00,
    p0 = 2.,check_finite = True,nan_policy='raise',bounds=[0,np.inf]
    )
...
p_tb_medium_r, c_tb_medium_r = curve_fit(
    i_tb_M_R,Thetas,I00,
    p0 = [2.,2.,0.5,0.],check_finite = True,nan_policy='raise',bounds=[[1.5,1.5,0.,0.],[2.0,2.0,1.0,np.pi*2]]
    )
print(p_tb_medium_r)
print(c_tb_medium_r)
