function [] = WritePythonInfo(a1,a2,b1,b2,Nsuper,Theta,Nensemble,inputEntropy,defectDensity,Ndefect)
  ...
  entropstr = [char(num2str(Ndefect))];
  defstr = [char(num2str(inputEntropy))];
  denstr = [char(num2str(defectDensity,'%e'))];
